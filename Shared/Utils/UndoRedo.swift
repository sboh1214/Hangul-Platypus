...
///
/// [guillermomuntaner/Burritos](https://github.com/guillermomuntaner/Burritos)
@propertyWrapper
public struct UndoRedo<Value> {
    ...
    /// If there are previous values it replaces the current value with the previous one and returns true,
